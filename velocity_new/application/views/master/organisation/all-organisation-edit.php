    ...
    <div class="page-content container-fluid">
        <div class="panel">
            <div class="panel-heading">
                <center><h2 class="panel-title">Edit Organisation &nbsp;  </center>
				<br><br>
          <div class="pull-right padding-bottom-20">
           ...
           <!--  <a target="_blank" href="<?php echo site_url('clients/exportToExcel'); ?>">
			...
			foreach($company as $details){?>
                    <form class="form-horizontal col-sm-12" id="exampleStandardForm" method="POST" action="<?php echo site_url('organisation/updatemember'); ?>" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
							   ...
							   <div class="col-sm-6">
                                <div class="form-group form-material">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" placeholder="" name="txtmobile" value="<?php echo $details->company_alternate_no; ?>" class="form-control" />
                                    </div>
                                </div>
                            </div>
						</div>
                            ...
                            <div class="col-sm-6">
							 ...
							 <div class="col-sm-6">
                                <div class="form-group form-material">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" placeholder="" name="txtgst" value="<?php echo $details->gst_no; ?>" class="form-control" required />
                                    </div>
                                </div>
                            </div>
