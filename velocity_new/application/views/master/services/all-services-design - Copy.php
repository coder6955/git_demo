						  ...
						  <div class="example-wrap">
							...
							<div class="example">
								...
								<select class="multi-select-methods form-control" onchange="list();">
								  ...
								  <option name="<?php echo $ld1->checklist_id;?>" value="<?php echo $ld1->checklist_id;?>">
								  <?php  echo $ld1->checklist_name?></option>	  
								  <?php } */?>
							...
							<div class="text" style="display:none" onchange="temp()">
							
								<span class="test"><?php echo $temp1;?></span>
							</div>
						  </div>
...
function test()
{
	...
	var x = $("#hidden_value").val();
	var y = x.split(",");

	$('.ms-selectable .ms-list li span').each(function (){
		var z = $(this).text();
